...
function addObjects(){
    ...
    var cubeTexture = new THREE.ImageUtils.loadTexture( 'box.jpg' );
    ...
    var cubeTexture = new THREE.ImageUtils.loadTexture( 'sky.jpg' );
...
function update()
{
    ...
    else { //po ukonceni intersekcie sa objektu priradi povodna farba
        if (INTERSECTED)
        {
            INTERSECTED.material.color.setHex(INTERSECTED.currentHex);
        }
